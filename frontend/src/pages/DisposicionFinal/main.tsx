...
export default function CertificadoDisposicionFinal() {
  ...
  const onUpdate = async () => {
    try {
      // Obtén los nuevos datos de certificados
      const updatedCertificados = await getCertificados();
      setCertificados(updatedCertificados); // Actualiza el estado de `certificados`
  
      // Convierte los IDs de cliente a nombres y actualiza `certificadosWithClientName`
